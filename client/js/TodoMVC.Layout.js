...
TodoMVC.module('Layout', function (Layout, App, Backbone) {
	...
	Layout.Footer = Backbone.Marionette.ItemView.extend({
		...
		events: {
			...
			'click #chartfilters a' : 'onChartClick'
		},
		...
		onChartClick: function(ev){
			this.ui.chartfilters.removeClass('selected');
		...
		initialize: function () {
			...
			this.collection.on("change", this.updateChart, this);
		},
		...
		updateChart:function(){
			...
			var type = $("#chartfilters a.selected").data("type");
			HighCharts.renderGraph(type, data)
		},
